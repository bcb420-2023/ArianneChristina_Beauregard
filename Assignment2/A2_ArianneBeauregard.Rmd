...
pat_colors <- pat_colors[factor(colnames(normalized_count_data))]
limma::plotMDS(normalized_count_data,
               col = pat_colors, pch = 1, ylim = c(-1, 2.5))
title("MDS Plot of Samples")
legend("topright", fill=pat_colors,legend=factor(colnames(normalized_count_data)), cex = 0.5, ncol = 4)
```
